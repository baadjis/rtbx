...
export default function DesignTab({ form, lang, supabase, router }: any) {
  ...
  // ← changement 1 : accepte (fields, settings)
  const handleSaveFields = async (updatedFields: any[], updatedSettings: any) => {
    setLoading(true)
    setSuccess(false)
    try {
      const { error } = await supabase
        ...
        .update({
          ...
          settings: updatedSettings, // ← sauvegarde mode/theme/active
    ...
    <div className="space-y-8 animate-in slide-in-from-right-8 duration-500">
      ...
      <div className="pt-4">
        <FormBuilder
          ...
          lang={lang}
          loading={loading}
          formSettings={form.settings || {}}  // ← changement 2 : passe les settings actuels
        />
      </div>
