...
tab_badges: "Badges" ,
  ...
  pdf_font_tip: "Le rendu final en PDF utilisera des polices haute définition pour une impression parfaite.",
   preview_instruction: "Basculez sur l'onglet 'Aperçu Direct' pour visualiser le montage complet de vos badges.",
    front_label: "Face 1 (Recto)",
    back_label: "Face 2 (Verso)",
    inside_left: "Face 3 (Intérieur G)",
    inside_right: "Face 4 (Intérieur D)",
    assembly_a4: "Montage A4 Pliable",
    assembly_dual: "Rendu Recto / Verso",
  ...
  custom_fields_json: "Questions personnalisées (JSON)",
  ...
  pdf_font_tip: "The final PDF output uses high-definition fonts to ensure a perfect, professional print.",
     preview_instruction: "Switch to the 'Live Preview' tab to visualize the full assembly of your badges.",
    front_label: "Side 1 (Front)",
    back_label: "Side 2 (Back)",
    inside_left: "Side 3 (Inside L)",
    inside_right: "Side 4 (Inside R)",
    assembly_a4: "Foldable A4 Assembly",
    assembly_dual: "Front / Back Render",
  ...
  custom_fields_json: "Custom Questions (JSON)",
