...
const DICT = {
  fr: {
    ...
    services_list: [
      ...
      { id: "short", title: "Shortener Pro", desc: "Réduisez vos URLs de boutique et suivez le nombre de clics sur rtbx.space.", link: "https://baadjis-utilitybox.hf.space/shortener", icon: Link2 },
