// Ajoute ces traductions dans ton fichier Data

export const Data = {
  // === MCP TRANSLATIONS ===
fr: {
  mcp_title: "RTBX AI",
  mcp_subtitle: "Ton assistant",
  ...
  mcp_suggestion_create_business: "Créer un nouveau Business",
  mcp_suggestion_create_short_link: "Créer un lien court",
  mcp_suggestion_ideas: "Donne-moi des idées",
...
ai_new_chat: "Nouveau chat",
  ai_choose_context: "Choisissez un contexte pour commencer",
  ai_context_general: "Général",
  ai_context_general_desc: "Questions, idées, aide générale",
  ai_context_shortener: "Liens courts",
  ai_context_shortener_desc: "Créer et gérer vos liens",
  ai_context_business: "Business",
  ai_context_business_desc: "Gérer vos entreprises",
  ai_context_event: "Événements",
  ai_context_event_desc: "Créer et organiser des événements",
  ai_context_form: "Formulaires",
...
en: {
  ...
  mcp_suggestion_create_business: "Create a new Business",
  mcp_suggestion_create_short_link: "Create a short link",
  mcp_suggestion_ideas: "Give me some ideas",
  ...
  mcp_suggestion_analyze_link: "Analyze a link's performance",

  
  mcp_suggestion_update_address: "Update my address",
  mcp_suggestion_add_logo: "Add a logo",
...
ai_new_chat: "New Chat",
  ai_choose_context: "Choose a context to start",
  ai_context_general: "General",
  ai_context_general_desc: "Questions, ideas, general help",
  ai_context_shortener: "Short Links",
  ai_context_shortener_desc: "Create and manage your links",
  ai_context_business: "Business",
  ai_context_business_desc: "Manage your businesses",
  ai_context_event: "Events",
  ai_context_event_desc: "Create and organize events",
  ai_context_form: "Forms",
