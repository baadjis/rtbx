...
export default function ChatListPage({lang}:{lang:LangType}) {
      ...
      {chats.length === 0 && (
        <div className="flex flex-col items-center justify-center flex-1 px-4 py-20 gap-4">
          ...
          <div className="text-center space-y-1">
            <p className="text-white/50 text-sm font-medium">{t.ai_no_chat_yet}</p>
            <p className="text-white/25 text-xs">{t.ai_start_new_chat}</p>
          </div>
          <button
            onClick={() => router.push('/ai')}
