...
export default function SpaceHeader({
  ...
  return (
    <div className="relative space-y-7 animate-in fade-in zoom-in duration-700">
      {/* ========================================= */}
      {/* AVATAR */}
      {/* ========================================= */}
      <div className="relative w-fit mx-auto">
        <SpaceAvatar
          ...
          variant={variant}
          editMode={editMode}
          editable={editMode}                    // ← Important
          onUpload={onAvatarUpload}
          onRemove={onRemoveAvatar}
          isUploading={saving}                   // ← Pour afficher "Chargement..."
        />
      </div>
      ...
      <div className="space-y-4 text-center">
        {!editMode ? (
          <h1 className="text-4xl md:text-5xl font-black tracking-tight leading-tight uppercase italic text-white">
            {displayName}
          </h1>
        ) : (
          <div className="max-w-md mx-auto flex items-center gap-3 p-2 rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/10">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-white text-2xl md:text-3xl font-black uppercase italic border-none outline-none placeholder:text-white/30"
            />
          </div>
        )}
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          {editMode && (
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
              {saving ? (
                <>
                  <Upload size={12} className="animate-pulse text-white/70" />
